  ...
  ws.on("message", (msg) => {
    try {
      ...
      if (data.type === "create_room") {
        ...
        rooms[newCode] = {
          players: [{ name, id: playerId, ws, score: 0, role: "", guessed: false }],
          admin: playerId,
          round: 1,
          chainIndex: 0,
          turn: 0,
      ...
      if (data.type === "join_room") {
        ...
        room.players.push({ name, id: playerId, ws, score: 0, role: "", guessed: false });
        broadcast(roomCode, {
          type: "player_joined",
      ...
      if (data.type === "guess") {
        ...
        if (room.swapMatrix[swapKey]) return;
